...
from VILLAIN.utils import first_page, second_page
from VILLAIN.utils.database import get_lang
from VILLAIN.utils.decorators.language import LanguageStart, languageCB
from VILLAIN.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, HELP_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers
from VILLAIN.misc import SUDOERS
from time import time
import asyncio
from VILLAIN.utils.extraction import extract_user
    ...
    if cb == "hb9":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                "😎 Pehle Tushar Ko Papa Bol Jake 😆😆", show_alert=True
            )
        else:
